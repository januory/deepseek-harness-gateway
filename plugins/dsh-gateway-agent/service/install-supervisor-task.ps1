...
#
# The task runs at logon and restarts on failure. Restarting the SUPERVISOR also
# brings dsh back up (bootstrap checks the liveness probe); a dsh that crashes
# while the supervisor stays up is reported as `exited` and needs an explicit
